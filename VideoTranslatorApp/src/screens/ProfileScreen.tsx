...
import { apiService, UserProfile, SessionStats } from '../services/ApiService';
  ...
  useEffect(() => {
    ...
    async function loadData() {
      ...
      if (profileResp) {
        ...
        userStore.setProfile(profileResp);
      }
      if (statsResp) {
        setStats(statsResp);
      }
    ...
    <SafeAreaView style={styles.safeArea} edges={['top']}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.settingsSection}>
          ...
          <View style={styles.settingsGroup}>
            <SettingRow
              ...
              sub="Whisper Small (2 token/sn)"
              right={<Text style={styles.settingValue}>Small <Text style={styles.chevron}>›</Text></Text>}
            />
            <SettingRow
              icon="🌍"
              ...
              name="Hedef Dil"
              sub="Çevirilen dil"
              right={<Text style={styles.settingValue}>🇹🇷 Türkçe <Text style={styles.chevron}>›</Text></Text>}
            />
            <SettingRow
              icon="✨"
              ...
              right={<Text style={styles.settingValue}>Orta <Text style={styles.chevron}>›</Text></Text>}
            />
            <SettingRow
              icon="🔔"
        ...
        <View style={styles.settingsSection}>
          ...
          <View style={styles.settingsGroup}>
            <SettingRow icon="👤" iconBg="rgba(108,99,255,0.15)" name="Profili Düzenle" />
